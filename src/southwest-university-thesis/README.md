...
请从以下任意一个链接安装样式。 
- [从 GitHub 安装样式（最新）](https://github.com/zotero-cn/styles/./raw/main/src/southwest-university-thesis/southwest-university-thesis.csl)  
- [从 Jsdelivr 安装样式（GitHub 镜像，可能有 24h 延迟）](https://cdn.jsdelivr.net/gh/zotero-cn/styles@main/src/southwest-university-thesis/southwest-university-thesis.csl) 
- [从 Gitee 安装样式（国内镜像）](https://gitee.com/zotero-chinese/styles/./raw/main/src/southwest-university-thesis/southwest-university-thesis.csl) 
...
- [在 Gitee 查看样式](https://gitee.com/zotero-chinese/styles/./tree/main/src/southwest-university-thesis/southwest-university-thesis.csl) 
