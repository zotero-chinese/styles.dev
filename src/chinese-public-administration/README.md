...
1. 显示全部作者；2. 姓名缩写不加点；3. 中文不加页码；4. 无 DOI。  
...
- [从 GitHub 安装样式](https://github.com/zotero-cn/styles/./raw/main/src/chinese-public-administration/chinese-public-administration.csl)  
- [在 GitHub 查看样式文件](https://github.com/zotero-cn/styles/./tree/main/src/chinese-public-administration/chinese-public-administration.csl)  
